...
::
::   Homepage: https://github.com/khyberhamid
::      Email: khyber_hamid@hotmail.com
::
::============================================================================
...
set "blank="
set "mas=ht%blank%tps%blank%://github%blank%.com/khyberhamid/"
...
if not [%Act_OK%]==[1] (
echo.
echo In case of any issues, check https://githubmass%-%.com/khyberhamid
)
...
echo:   
echo   Homepage: https://github.com/khyberhamid
echo      Email: khyber_hamid@hotmail.com
)>"%_dest%\Info.txt"
exit /b
